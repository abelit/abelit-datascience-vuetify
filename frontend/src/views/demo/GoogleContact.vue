  ...
  data: () => ({
    ...
    items: [
      ...
      },
      {
        ...
        model: false,
        children: [
          { text: "Import" , icon: "cards-spade"},
          { text: "Export" , icon: "cards-spade"},
          { text: "Print" , icon: "cards-spade"},
          { text: "Undo changes", icon: "cards-spade" },
          { text: "Other contacts", icon: "cards-spade" }
        ]
      },
