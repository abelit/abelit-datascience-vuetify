        ...
        <v-col>
          <div class="text-center" >
            ...
            <v-chip
              ...
              @contextmenu.prevent.native="openMenu(tag,$event)"
            >Complete</v-chip>
            <v-chip tag v-if="chip1" class="ma-1" close @click:close="chip1 = false"
            @contextmenu.prevent.native="openMenu(tag,$event)"
            >Closable</v-chip>
            ...
            <v-chip
              ...
              color="red"
              text-color="white"
              @click:close.prevent.stop="chip2 = false"
              @contextmenu.prevent.native="openMenu(tag,$event)"
            >Remove</v-chip>
          ...
          <ul v-show="visible"  :style="{left:left+'px',top:top+'px'}"  class="contextmenuaa" slot="mytag">
            <li >Refresh</li>
            <li >Close</li>
            <li >Close Others</li>
            <li >Close All</li>
